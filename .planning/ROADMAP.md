...
- [x] 06-02-PLAN.md — Manejo de errores: ErrorUI module, banner localStorage, inline historial corrompido, inline form sin resultado, cadenas i18n FR/AR
- [x] 06-03-PLAN.md — Corrección de paths para GitHub Pages subpath (manifest.json, sw.js), verificación tamaño < 400KB
...
| 6. Pulido y despliegue | 3/4 | In Progress|  |
